...
exports.sourceNodes = async ({
  ...
  }, // Creates links between authors and user entities
  {
    ...
    normalizer: ({
      entities
    }) => normalize.mapAuthorsToUsers(entities)
  ...
  }, // Normalize menu items
  {
    ...
    normalizer: ({
      entities
    }) => normalize.normalizeMenuItems(entities)
  }, // Creates links from entities to media nodes
  {
    name: `mapEntitiesToMedia`,
    normalizer: ({
      entities
    }) => normalize.mapEntitiesToMedia(entities)
  ...
  }, // Creates links between elements and parent element.
  {
    ...
    normalizer: ({
      entities
    }) => normalize.mapElementsToParent(entities)
  }, // Search and replace Content Urls
  {
    ...
    normalizer: ({
      entities
    }) => normalize.mapPolylangTranslations(entities)
  }, {
    name: `createUrlPathsFromLinks`,
    normalizer: ({
      entities
    }) => normalize.createUrlPathsFromLinks(entities)
  }];
  ...
  for (const {
    normalizer
  } of wordpressDataNormalizers) {
    entities = await normalizer(Object.assign({
      entities
    }, normalizerHelpers));
  }
